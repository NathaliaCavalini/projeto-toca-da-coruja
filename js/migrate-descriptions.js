...
(function () {
  ...
  if (totalChanged > 0) {
    const msg = `✅ Migração concluída: ${totalChanged} descrições foram ajustadas para formato curto.`;
    console.log(`🎉 ${msg}`);
    // Use non-blocking toast if available, otherwise log to console.
    if (
      ...
      // fallback to console only (no alert)
      console.log(msg);
    }
  } else {
